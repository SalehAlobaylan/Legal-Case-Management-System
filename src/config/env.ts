...
const envSchema = z.object({
  ...
  REG_SOURCE_SYNC_ENABLED: envBoolean(true),
  ...
  CASE_DOC_EXTRACTION_ENABLED: envBoolean(true),
  ...
  CASE_DOC_INSIGHTS_ENABLED: envBoolean(true),
  ...
  REG_INSIGHTS_ENABLED: envBoolean(true),
  ...
  REG_IMPACT_ENABLED: envBoolean(true),
  ...
  CASE_LINK_REQUIRE_DOCS_READY: envBoolean(false),
  CASE_LINK_MIN_READY_DOCS: z.coerce.number().int().min(0).default(1),
  CASE_LINK_MAX_PENDING_DOCS: z.coerce.number().int().min(0).default(0),
  ...
  CASE_LINK_STRICT_MODE: envBoolean(true),
  ...
  CASE_LINK_REQUIRE_CASE_SUPPORT: envBoolean(true),
  ...
  AI_EVAL_LABELS_FILE: z.string().default("./reports/case-link-eval-labels.json"),
  AI_EVAL_OUTPUT_DIR: z.string().default("./reports"),
